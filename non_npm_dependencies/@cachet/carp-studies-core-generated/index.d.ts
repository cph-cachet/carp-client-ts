...
export declare namespace dk.cachet.carp.data.application {
    interface DataStreamBatch /* extends kotlin.sequences.Sequence<dk.cachet.carp.data.application.DataStreamPoint<any>> */ {
        readonly sequences: any/* kotlin.sequences.Sequence<dk.cachet.carp.data.application.DataStreamSequence<any>> */;
        isEmpty(): boolean;
        ...
        readonly __doNotUseOrImplementIt: {
            readonly "dk.cachet.carp.data.application.DataStreamBatch": unique symbol;
        };
    }
    class MutableDataStreamBatch implements dk.cachet.carp.data.application.DataStreamBatch {
        constructor();
        get sequences(): any/* kotlin.sequences.Sequence<dk.cachet.carp.data.application.DataStreamSequence<any>> */;
        appendSequence(sequence: dk.cachet.carp.data.application.DataStreamSequence<any /*any*/>): void;
        appendBatch(batch: dk.cachet.carp.data.application.DataStreamBatch): void;
        equals(other: Nullable<any>): boolean;
        hashCode(): number;
        iterator(): any/* kotlin.collections.Iterator<dk.cachet.carp.data.application.DataStreamPoint<any>> */;
        isEmpty(): boolean;
        getDataStreamPoints(dataStream: dk.cachet.carp.data.application.DataStreamId): any/* kotlin.sequences.Sequence<dk.cachet.carp.data.application.DataStreamPoint<any>> */;
...
export declare namespace dk.cachet.carp.data.application {
    class DataStreamId {
        constructor(studyDeploymentId: dk.cachet.carp.common.application.UUID, deviceRoleName: string, dataType: dk.cachet.carp.common.application.NamespacedId);
        ...
        copy(studyDeploymentId?: dk.cachet.carp.common.application.UUID, deviceRoleName?: string, dataType?: dk.cachet.carp.common.application.NamespacedId): dk.cachet.carp.data.application.DataStreamId;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
        static get Companion(): {
...
export declare namespace dk.cachet.carp.data.application {
    interface DataStreamSequence<TData extends dk.cachet.carp.common.application.data.Data> /* extends kotlin.sequences.Sequence<dk.cachet.carp.data.application.DataStreamPoint<TData>> */ {
        ...
        readonly __doNotUseOrImplementIt: {
            readonly "dk.cachet.carp.data.application.DataStreamSequence": unique symbol;
        };
    }
    class MutableDataStreamSequence<TData extends dk.cachet.carp.common.application.data.Data> implements dk.cachet.carp.data.application.DataStreamSequence<TData> {
        ...
        equals(other: Nullable<any>): boolean;
        hashCode(): number;
        get range(): any/* kotlin.ranges.LongRange */;
        throwIfIllegalState(): void;
...
export declare namespace dk.cachet.carp.data.application {
    ...
    namespace DataStreamsConfiguration {
        class ExpectedDataStream {
            ...
            get deviceRoleName(): string;
            get dataType(): dk.cachet.carp.common.application.NamespacedId;
            copy(deviceRoleName?: string, dataType?: dk.cachet.carp.common.application.NamespacedId): dk.cachet.carp.data.application.DataStreamsConfiguration.ExpectedDataStream;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
...
export declare namespace dk.cachet.carp.data.infrastructure {
    ...
    namespace DataStreamServiceRequest {
        class OpenDataStreams extends dk.cachet.carp.data.infrastructure.DataStreamServiceRequest<void> {
            ...
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<void> */;
            copy(configuration?: dk.cachet.carp.data.application.DataStreamsConfiguration): dk.cachet.carp.data.infrastructure.DataStreamServiceRequest.OpenDataStreams;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class AppendToDataStreams extends dk.cachet.carp.data.infrastructure.DataStreamServiceRequest<void> {
            ...
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<void> */;
            copy(studyDeploymentId?: dk.cachet.carp.common.application.UUID, batch?: dk.cachet.carp.data.application.DataStreamBatch): dk.cachet.carp.data.infrastructure.DataStreamServiceRequest.AppendToDataStreams;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
...
export declare namespace dk.cachet.carp.studies.application.users {
    class AssignedParticipantRoles {
        constructor(participantId: dk.cachet.carp.common.application.UUID, assignedRoles: dk.cachet.carp.common.application.users.AssignedTo);
        get participantId(): dk.cachet.carp.common.application.UUID;
        get assignedRoles(): dk.cachet.carp.common.application.users.AssignedTo;
        copy(participantId?: dk.cachet.carp.common.application.UUID, assignedRoles?: dk.cachet.carp.common.application.users.AssignedTo): dk.cachet.carp.studies.application.users.AssignedParticipantRoles;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
        static get Companion(): {
...
export declare namespace dk.cachet.carp.studies.application.users {
    class Participant {
        constructor(accountIdentity: dk.cachet.carp.common.application.users.AccountIdentity, id?: dk.cachet.carp.common.application.UUID);
        get accountIdentity(): dk.cachet.carp.common.application.users.AccountIdentity;
        get id(): dk.cachet.carp.common.application.UUID;
        copy(accountIdentity?: dk.cachet.carp.common.application.users.AccountIdentity, id?: dk.cachet.carp.common.application.UUID): dk.cachet.carp.studies.application.users.Participant;
        toString(): string;
        hashCode(): number;
        equals(other: Nullable<any>): boolean;
        static get Companion(): {
...
export declare namespace dk.cachet.carp.studies.infrastructure {
    ...
    namespace RecruitmentServiceRequest {
        class AddParticipantByEmailAddress extends dk.cachet.carp.studies.infrastructure.RecruitmentServiceRequest<dk.cachet.carp.studies.application.users.Participant> {
            ...
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.users.Participant> */;
            matchesServiceRequest(request: any/* kotlin.reflect.KCallable<any> */): boolean;
            copy(studyId?: dk.cachet.carp.common.application.UUID, email?: dk.cachet.carp.common.application.EmailAddress): dk.cachet.carp.studies.infrastructure.RecruitmentServiceRequest.AddParticipantByEmailAddress;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class AddParticipantByUsername extends dk.cachet.carp.studies.infrastructure.RecruitmentServiceRequest<dk.cachet.carp.studies.application.users.Participant> {
            ...
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.users.Participant> */;
            matchesServiceRequest(request: any/* kotlin.reflect.KCallable<any> */): boolean;
            copy(studyId?: dk.cachet.carp.common.application.UUID, username?: dk.cachet.carp.common.application.users.Username): dk.cachet.carp.studies.infrastructure.RecruitmentServiceRequest.AddParticipantByUsername;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class GetParticipant extends dk.cachet.carp.studies.infrastructure.RecruitmentServiceRequest<dk.cachet.carp.studies.application.users.Participant> {
            ...
            get participantId(): dk.cachet.carp.common.application.UUID;
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.users.Participant> */;
            copy(studyId?: dk.cachet.carp.common.application.UUID, participantId?: dk.cachet.carp.common.application.UUID): dk.cachet.carp.studies.infrastructure.RecruitmentServiceRequest.GetParticipant;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class StopParticipantGroup extends dk.cachet.carp.studies.infrastructure.RecruitmentServiceRequest<dk.cachet.carp.studies.application.users.ParticipantGroupStatus> {
            ...
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.users.ParticipantGroupStatus> */;
            copy(studyId?: dk.cachet.carp.common.application.UUID, groupId?: dk.cachet.carp.common.application.UUID): dk.cachet.carp.studies.infrastructure.RecruitmentServiceRequest.StopParticipantGroup;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
...
export declare namespace dk.cachet.carp.studies.infrastructure {
    ...
    namespace StudyServiceRequest {
        class CreateStudy extends dk.cachet.carp.studies.infrastructure.StudyServiceRequest<dk.cachet.carp.studies.application.StudyStatus> {
            ...
            get name(): string;
            get description(): Nullable<string>;
            get invitation(): Nullable<dk.cachet.carp.deployments.application.users.StudyInvitation>;
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.StudyStatus> */;
            copy(ownerId?: dk.cachet.carp.common.application.UUID, name?: string, description?: Nullable<string>, invitation?: Nullable<dk.cachet.carp.deployments.application.users.StudyInvitation>): dk.cachet.carp.studies.infrastructure.StudyServiceRequest.CreateStudy;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class SetInternalDescription extends dk.cachet.carp.studies.infrastructure.StudyServiceRequest<dk.cachet.carp.studies.application.StudyStatus> {
            ...
            get description(): Nullable<string>;
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.StudyStatus> */;
            copy(studyId?: dk.cachet.carp.common.application.UUID, name?: string, description?: Nullable<string>): dk.cachet.carp.studies.infrastructure.StudyServiceRequest.SetInternalDescription;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class GetStudyDetails extends dk.cachet.carp.studies.infrastructure.StudyServiceRequest<dk.cachet.carp.studies.application.StudyDetails> {
            ...
            copy(studyId?: dk.cachet.carp.common.application.UUID): dk.cachet.carp.studies.infrastructure.StudyServiceRequest.GetStudyDetails;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class GetStudyStatus extends dk.cachet.carp.studies.infrastructure.StudyServiceRequest<dk.cachet.carp.studies.application.StudyStatus> {
            ...
            get studyId(): dk.cachet.carp.common.application.UUID;
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.StudyStatus> */;
            copy(studyId?: dk.cachet.carp.common.application.UUID): dk.cachet.carp.studies.infrastructure.StudyServiceRequest.GetStudyStatus;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class SetInvitation extends dk.cachet.carp.studies.infrastructure.StudyServiceRequest<dk.cachet.carp.studies.application.StudyStatus> {
            ...
            get invitation(): dk.cachet.carp.deployments.application.users.StudyInvitation;
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.StudyStatus> */;
            copy(studyId?: dk.cachet.carp.common.application.UUID, invitation?: dk.cachet.carp.deployments.application.users.StudyInvitation): dk.cachet.carp.studies.infrastructure.StudyServiceRequest.SetInvitation;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class SetProtocol extends dk.cachet.carp.studies.infrastructure.StudyServiceRequest<dk.cachet.carp.studies.application.StudyStatus> {
            ...
            get protocol(): dk.cachet.carp.protocols.application.StudyProtocolSnapshot;
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.StudyStatus> */;
            copy(studyId?: dk.cachet.carp.common.application.UUID, protocol?: dk.cachet.carp.protocols.application.StudyProtocolSnapshot): dk.cachet.carp.studies.infrastructure.StudyServiceRequest.SetProtocol;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class RemoveProtocol extends dk.cachet.carp.studies.infrastructure.StudyServiceRequest<dk.cachet.carp.studies.application.StudyStatus> {
            ...
            get studyId(): dk.cachet.carp.common.application.UUID;
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.StudyStatus> */;
            copy(studyId?: dk.cachet.carp.common.application.UUID): dk.cachet.carp.studies.infrastructure.StudyServiceRequest.RemoveProtocol;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class GoLive extends dk.cachet.carp.studies.infrastructure.StudyServiceRequest<dk.cachet.carp.studies.application.StudyStatus> {
            ...
            get studyId(): dk.cachet.carp.common.application.UUID;
            getResponseSerializer(): any/* kotlinx.serialization.KSerializer<dk.cachet.carp.studies.application.StudyStatus> */;
            copy(studyId?: dk.cachet.carp.common.application.UUID): dk.cachet.carp.studies.infrastructure.StudyServiceRequest.GoLive;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
        ...
        class Remove extends dk.cachet.carp.studies.infrastructure.StudyServiceRequest<boolean> {
            ...
            copy(studyId?: dk.cachet.carp.common.application.UUID): dk.cachet.carp.studies.infrastructure.StudyServiceRequest.Remove;
            toString(): string;
            hashCode(): number;
            equals(other: Nullable<any>): boolean;
            static get Companion(): {
...
export as namespace dk_cachet_carp_studies_carp_studies_core;